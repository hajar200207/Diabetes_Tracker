      ...
      <div class="tm-left">
        <div class="tm-left-inner">
          <div class="tm-site-header">
            <i >
<img src="../Diabetes.png" width="100" height="100">            </i>
            <h1 class="tm-site-name">Diabetes Trackerhajar</h1>
          </div>
          <nav class="tm-site-nav">
            <ul class="tm-site-nav-ul">
              <li class="tm-page-nav-item">
                <a href="#Conseils" class="tm-page-link active">
               
                  <span>Conseils Diabetes </span>
                </a>
              </li>
              <li class="tm-page-nav-item">
                <a href="#about" class="tm-page-link">
                 
                  <span>About Diabetes Trackerhajar</span>
                </a>
              </li>
              <li class="tm-page-nav-item">
                <a href="#connecter" class="tm-page-link">
                
                  <span>Se connecter</span>
                </a>
              </li>
              <li class="tm-page-nav-item">
                <a href="#Enregistrez" class="tm-page-link">
                  
                  <span>Enregistrez votre glycémie</span>
                </a>
              </li>
              <li class="tm-page-nav-item">
                <a href="#liste " class="tm-page-link">
                  <span> liste des lectures</span>
                </a>
              </li>
              <li class="tm-page-nav-item">
      ...
      <div class="tm-right">
        <main class="tm-main">
          <div id="Conseils" class="tm-page-content">
            <!-- Conseils Menu Page -->
          ...
          <!-- connecter  Page -->
          <div id="connecter" class="tm-page-content">
          ...
          <!-- Enregistrez Page -->
          <div id="Enregistrez" class="tm-page-content">
          ...
          <!-- end Enregistrez Page -->
          <!-- liste Page -->
          <div id="liste" class="tm-page-content">
            <div class="tm-special-items">
              <div class="tm-black-bg tm-special-item">
                <img src="img/special-01.jpg" alt="Image">
                <div class="tm-special-item-description">
    ...
    <footer class="tm-site-footer">
      <p class="tm-black-bg tm-footer-text">Copyright 2024 Diabetes Trackerhajar
      
      | Design: <a href="index.html" class="tm-footer-link" rel="sponsored" target="_parent">Diabetes Trackerhajar</a></p>
    </footer>
  </div>
  ...
  <div class="tm-video-wrapper">
      ...
      <video autoplay muted loop id="tm-video">
          <source src="video/Diabetes Tracker.mp4" type="video/mp4">
      </video>
  </div>
